...
function score_time_counting(add_time,add_score){score=score+add_score;playSound(loadSound("./bonus_pick.mp3"),false);time=time+add_time;setHTMLElemAttribute('innerHTML',time,'Time',true);setHTMLElemAttribute('innerHTML',score,'Score',true);}
