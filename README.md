Project N-Dimensions and its author: florencio Valladlid Rodriguez
 ...
 It leaves you free and full access to the first video game or 3D demo, "un mundo nuevo" as a powerful example of an app for the web,  that only needs the web browser of any device, of code free made  with the 3d engine webgl "verge3d"  in javascript, html5 and css3, and the current state of development using only blender, gimp and audacity and notepad ++, has no  nothing to envy to genres of video games as shooters, puzzle, simulation, adventures ... etc of other engines that are generated as native app and require for its access to specific high-end equipment.

Its simplicity and fast implementation, clearly differentiates it for be ideal to start in 3d developments, learning and this development, just need to support it in its crowdfounding  to get beyond it to be a multiplayer online game and without limits more than the hardware and that we are imposed by web browsers that luckily is improving day by day.  
...
testing:
already playable directly on www.n-dimensiones.es or https://play.google.com/store/apps/details?id=es.n.dimensiones.unmundonuevo&hl=es

I recommend reading the guide before https://www.n-dimensiones.es/main/guia-del-juego-webgl-con-verge3d-un-mundo-nuevo


For devolop

Once downloaded the engine verge3d,
...
On the cover of the website,
https://www.n-dimensiones.es
 as here is available the following coupon code "florencio.valladolid" so that you can enjoy a discount of 5% that I can provide thanks to the issuance of these videotutorials verge3d.
